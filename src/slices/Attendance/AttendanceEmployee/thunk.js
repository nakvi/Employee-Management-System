...
export const getAttendanceEmployee = createAsyncThunk(
  "attendanceEmployee/getAttendanceEmployee",
  async (params, { rejectWithValue }) => {
    if (!params.etypeid) {
      toast.error("E-Type is required.");
      return rejectWithValue("E-Type is required.");
    }
    try {
...
export const saveAttendanceEmployee = createAsyncThunk(
  "attendanceEmployee/saveAttendanceEmployee",
  async (record, { rejectWithValue }) => {
    try {
      ...
      const payload = {
        ...
        remarks: String(record.remarks || "Attendance entry"),
        uID: record.uID || 1,
...
export { resetAttendanceEmployeeData };