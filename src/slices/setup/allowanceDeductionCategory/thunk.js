...
// const API_ENDPOINT = "http://192.168.18.65:8001/ems/allowDedCat/";
const API_ENDPOINT = `${config.api.API_URL}allowDedCat/`;

// Create the async thunk
export const getAllowanceDeductionCategory = createAsyncThunk(
  "getAllowanceDeductionCategory/getAllowanceDeductionCategory",
