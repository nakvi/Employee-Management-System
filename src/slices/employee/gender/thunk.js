...
// const API_ENDPOINT = "http://192.168.18.65:8001/ems/gender/";
const API_ENDPOINT = `${config.api.API_URL}gender/`;



export const getGender = createAsyncThunk("gender/geteGender",
