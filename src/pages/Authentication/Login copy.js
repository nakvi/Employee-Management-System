...
const Login = () => {
  ...
  // Function to fetch user locations based on email
  
useEffect(() => {
  const delayDebounceFn = setTimeout(() => {
    if (validation.values.email && validation.values.email.includes("@")) {
      fetchUserLocations(validation.values.email)
        .then((locations) => {
  ...
  return () => clearTimeout(delayDebounceFn); // cleanup on new keystroke
                      ...
                      >
                        ...
                        {/* {showLocationDropdown && (
                          <div className="mb-3">
                            ...
                            >
                              <option value="">---Select---</option>
                              <option value="001:Sir Amir:Hr">Lahore</option>
                              <option value="002:Sir Ijaz:HOD">Islamabad</option>
                            </Input>
                          </div>
                        )} */}
