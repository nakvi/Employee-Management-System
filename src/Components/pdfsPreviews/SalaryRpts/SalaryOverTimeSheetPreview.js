...
const SalaryOverTimeSheetPreview = ({ allEmployees = [], reportHeading, dateFrom, dateTo }) => {
  ...
  const columns = [
    { key: "srl", label: "Srl#", width: "auto" },
    { key: "EmpCode", label: "E-Code", width: "auto" },
    { key: "EName", label: "Name", width: "auto" },
    { key: "Designation", label: "Designation", width: "auto" },
    { key: "SalaryWithAllow", label: "Gross Salary", width: "auto" },
    { key: "OverTime", label: "Hours", width: "auto" },
    { key: "OverTimeRs", label: "Amount", width: "auto" },
    { key: "Signature", label: "RECIPIENT SIGNATURE", width: "auto" },
  ];
...
export default SalaryOverTimeSheetPreview;