...
// Fixed columns for Absentees report
const columns = [
...
const AbsenteesPreview = ({ groupedData, reportHeading, reportDate }) => {
  const reportRef = useRef();
    ...
    sections.forEach((section) => {
      autoTable(doc, {
        ...
        columnStyles: {
          ...
          2: { halign: 'left', cellWidth: 180 },    // Name
          3: { halign: 'left', cellWidth: 180 },    // Designation
          4: { halign: 'left', cellWidth: 110 },     // Remarks
        },
        didDrawPage: function () {
          ...
          if (reportHeading && reportHeading.trim() !== "") {
            ...
            doc.text(`Absentees report for the date ${reportDate}`, 40, 75);
          }
          doc.setFontSize(8);
